...
export class LocalProvider {
    ...
    static OFF_TOPIC = /\b(recipe|weather|forecast|sports?|travel|vacation|movie|film|music|joke|poem|story|cooking|translate|translation|politics|what is your name|who (is|was))\b/i;
    ...
    async consult(question, findings) {
        if (LocalProvider.OFF_TOPIC.test(question)) {
            return {
                answer: 'lexis-guard is scoped to API cybersecurity and API performance. ' +
