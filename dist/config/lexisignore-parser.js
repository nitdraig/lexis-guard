import { lexisignoreSchema } from './lexisignore-schema.js';
/**
 ...
 */
export function parseLexisignore(content) {
    let raw;
    ...
    if (expired.length > 0) {
        const errors = expired.map((e) => `Expired ignore entry: hash=${e.hash} rule_id=${e.rule_id} path=${e.path} ` +
 ...
 */
export function parseLexisignoreStrict(content) {
...
//# sourceMappingURL=lexisignore-parser.js.map