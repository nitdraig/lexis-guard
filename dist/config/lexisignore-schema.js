...
export const ignoredFindingSchema = z.object({
    ...
    expires: z.string().refine((val) => !Number.isNaN(Date.parse(val)), { message: 'expires must be a valid ISO 8601 date string' })
});
/**
...
//# sourceMappingURL=lexisignore-schema.js.map